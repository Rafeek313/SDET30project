...
public class CreateOrgWithIndTests {
	...
	public void createOrgWithIndTest() throws Throwable
	{
		...
		String indName = cell.getStringCellValue();
		...
		/*choose "healthcare" from industry dropdown and save */
		WebElement indlst = driver.findElement(By.xpath("//select[@name='industry']"));
		Select s=new Select(indlst);
		Thread.sleep(5000);
		s.selectByValue(indName);
